...
import { Linking, Pressable, Text, View as NativeView } from 'react-native'
  ...
  return (
    <NativeView style={{ alignItems: 'flex-start' }}>
      ...
      {/*
        ...
        (Detox's `device.openURL()` reaching a warm app, several times per `describe`) remounts it
        - otherwise `initialCaseName` would only ever seed its useState once, on first mount.
      */}
