...
describe('@/components/molecules/gradient', () => {
  describe('circular gradient component', () => {
    ...
    it('renders radial gradient with center coordinates by default', () => {
      ...
      expect(radialGradient.props.cy).toEqual(0.5)
      expect(radialGradient.props.r).toEqual('50%')
      expect(radialGradient.props.fx).toEqual(0.5)
      expect(radialGradient.props.fy).toEqual(0.5)
    })
    ...
    it('renders radial gradient with provided cx and matching fx', () => {
      ...
      const radialGradient = UNSAFE_getByType(RadialGradient)
      expect(radialGradient.props.cx).toEqual(cx.toValue())
      expect(radialGradient.props.fx).toEqual(cx.toValue())
    })
    ...
    it('renders radial gradient with provided cy and matching fy', () => {
      ...
      const radialGradient = UNSAFE_getByType(RadialGradient)
      expect(radialGradient.props.cy).toEqual(cy.toValue())
      expect(radialGradient.props.fy).toEqual(cy.toValue())
    })
